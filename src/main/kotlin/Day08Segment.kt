 ...
 */
//class Digit() {
//    private val segments = ('a'..'g').associateWith { ('a'..'g').toSet() }.toMutableMap()
//
//    fun offer(digitSegments: Set<Char>) {
//        when (digitSegments.size) {
//            2 -> { //1
//                segments['c'] = segments['c']!!.intersect(digitSegments)
//                segments['f'] = segments['f']!!.intersect(digitSegments)
//            }
//            3 -> { //7
//                segments['a'] = segments['a']!!.intersect(digitSegments)
//                segments['c'] = segments['c']!!.intersect(digitSegments)
//                segments['f'] = segments['f']!!.intersect(digitSegments)
//            }
//            4 -> { // 4
//                segments['a'] = segments['a']!!.intersect(digitSegments)
//                segments['b'] = segments['b']!!.intersect(digitSegments)
//                segments['c'] = segments['c']!!.intersect(digitSegments)
//                segments['f'] = segments['f']!!.intersect(digitSegments)
//            }
//            7 -> { //8
...
//                segments['b'] = segments['b']!!.intersect(digitSegments)
//                segments['c'] = segments['c']!!.intersect(digitSegments)
//                segments['d'] = segments['d']!!.intersect(digitSegments)
//                segments['e'] = segments['e']!!.intersect(digitSegments)
//                segments['f'] = segments['f']!!.intersect(digitSegments)
//                segments['g'] = segments['g']!!.intersect(digitSegments)
//            }
//            else -> {
//                segments['a'] = segments['a']!!.intersect(digitSegments)
//                segments['b'] = segments['b']!!.intersect(digitSegments)
